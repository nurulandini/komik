...
<div class="row">
	<div class="col-md-12">
		<div class="container" style="background-color: #8a9dab;border-width: 1px; width: 1120px; height: 500px; border-color:white;">
		 ...
		 <p style="font-family: Trajan Pro; font-size: 35px;color: white; padding-top: 20px; text-align: center; ">ACTION</p><hr color="white">
		  	<?php $i=0;?>
		 	<?php
		 		$requestURL = getUrlDbpediaAction($term);
