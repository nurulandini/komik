<div class="row">
	<div class="col-md-12">
			...
			<div id="demo" class="carousel slide" data-ride="carousel">
			  ...
			  <div class="carousel-inner" >
			    ...
			    <div class="carousel-item">
			      <img src="<?php echo base_url()?>/img/naruto.jpg" alt="Chicago" style="height:150px; width:100px; margin-top: 18px; margin-left: 100px; width: 160px; height: 220px;">
			    </div>
			    <div class="carousel-item">
			      <img src="<?php echo base_url()?>/img/2.jpg" alt="New York">
			    </div>
			  </div>
		...
		<div class="row" style="padding-top: 2em;padding-bottom: -100px">
			...
			<div class="col-md-4">
				<div class="container" style="border-width: 0px;background-color: #0e2854;height: 60px;color: white;text-align: center; padding-top: 3px; font-family: Trajan Pro; font-size: 30px;width: 360px;">
					<a  class="nav-link text-uppercase text-expanded" href="<?php echo base_url()?>Genre/horror" style="color: white;">HOROR</a>
				</div>
			</div>
		</div>
